...
import 'package:flash_chat_flutter2/constants.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  //       .collection('messages')
  //       .snapshots()) //automatically trigers itself when something is changed in firstore database
...
class MessagesStream extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      //this snapshot is async flutters snapshot
      builder: (context, snapshot) {
        ...
        var currUser = loggedInUser.email;
